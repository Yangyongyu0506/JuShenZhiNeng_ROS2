...
bool my_interfaces__srv__armabs__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // angle1
    ...
    ros_message->angle1 = (int8_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // angle2
    ...
    assert(PyLong_Check(field));
    ros_message->angle2 = (int8_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // angle3
    ...
    assert(PyLong_Check(field));
    ros_message->angle3 = (int8_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // angle4
    ...
    assert(PyLong_Check(field));
    ros_message->angle4 = (int8_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
