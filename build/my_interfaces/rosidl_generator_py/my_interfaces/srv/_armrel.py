...
class Armrel_Request(metaclass=Metaclass_Armrel_Request):
    ...
    def dangle1(self, value):
        if __debug__:
            ...
            assert value >= -32768 and value < 32768, \
                "The 'dangle1' field must be an integer in [-32768, 32767]"
        self._dangle1 = value
    ...
    def dangle2(self, value):
        if __debug__:
            ...
            assert value >= -32768 and value < 32768, \
                "The 'dangle2' field must be an integer in [-32768, 32767]"
        self._dangle2 = value
    ...
    def dangle3(self, value):
        if __debug__:
            ...
            assert value >= -32768 and value < 32768, \
                "The 'dangle3' field must be an integer in [-32768, 32767]"
        self._dangle3 = value
    ...
    def dangle4(self, value):
        if __debug__:
            ...
            assert value >= -32768 and value < 32768, \
                "The 'dangle4' field must be an integer in [-32768, 32767]"
        self._dangle4 = value
